<div x-data="editor" class="relative flex justify-end max-w-screen-2xl mx-auto bg-white border-x border-gray-100">
    ...
    <div id="preview" class="basis-1/2">
        <div class="p-16 max-w-none prose prose-gray prose-violet" x-html="parsedContent">
        </div>
    </div>

    <div class="absolute -mr-px right-full inset-y-0 flex flex-col items-end gap-y-1.5 pt-24">
        <div
